...
import { ICloneProgress } from './lib/progress/definitions';
import { IGitExecutionOptions } from './lib/execution';
import CloneProgressParser from './lib/progress/clone';
import executionOptionsWithProgress from './lib/progress/readSTD';
